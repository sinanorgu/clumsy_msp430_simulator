instruction_set = ["add","sub","call","jmp","inc","mov.b","mov","mov.w","dec","jne","jeq","jl","cmp","push","pop","ret","bis","bis.b","rra","rla",
...
def find_labels(code_lines,operation_addres,memory:list):
    parameter_list = code_lines[operation_addres]
